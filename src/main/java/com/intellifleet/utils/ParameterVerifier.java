...
public class ParameterVerifier {
	...
	public static String getString(Object arg, String defaultValue) {
		String str = defaultValue;
		try {
			if(isValidParam(arg) && StringUtils.isNotBlank(str)) {
				str = String.valueOf(arg);
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static long getLong(Object arg) {
		...
		try {
			if(isValidParam(arg)) {
				no = Long.parseLong(String.valueOf(arg));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static float getFloat(Object arg) {
		...
		try {
			if(isValidParam(arg)) {
				no = Float.parseFloat(String.valueOf(arg));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
